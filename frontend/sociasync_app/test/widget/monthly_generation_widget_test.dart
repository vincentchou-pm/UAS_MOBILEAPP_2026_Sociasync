...
void main() {
  group('Monthly Summary Widget Tests', () {
    ...
    testWidgets('menampilkan tanggal rentang default dan chart loader', (
      tester,
    ) async {
      await pumpMonthlySummaryPage(tester);
    ...
    testWidgets('menampilkan insight card dan bottom navbar', (tester) async {
      await pumpMonthlySummaryPage(tester);
