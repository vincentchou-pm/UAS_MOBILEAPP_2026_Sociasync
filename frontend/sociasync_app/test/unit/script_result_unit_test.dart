...
void main() {
  ...
  group('ScriptResultPage - Render UI', () {
    ...
    testWidgets('menampilkan tombol aksi yang sesuai pada halaman', (
      tester,
    ) async {
      await pumpScriptResultPage(tester);
  ...
  group('ScriptResultPage - Method actions', () {
    ...
    testWidgets('copySingle menampilkan snackbar untuk item HOOK', (
      tester,
    ) async {
      await pumpScriptResultPage(tester);
